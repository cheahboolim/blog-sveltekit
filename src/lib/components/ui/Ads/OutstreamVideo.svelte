<script lang="ts">
  ...
  export let zoneId: string = '5695572';
  export let className: string = 'eas6a97888e37';
...
<style>
  /* Video ad specific styling */
  ins {
    display: block;
    /* Add any video-specific styling here */
    min-height: 250px; /* Typical video ad height */
    width: 100%;
  }
</style>